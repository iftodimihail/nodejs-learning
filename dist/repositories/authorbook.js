...
exports.default = function (db) {
  var authorBookModel = db.authorbook;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return authorBookModel.create(body);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return authorBookModel.findByPk(id);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return authorBookModel.update(body, { where: { id: id } });
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 3:
              ...
              _context5.next = 7;
              return authorBook.destroy();

            case 7:
              return _context5.abrupt('return', authorBook);
